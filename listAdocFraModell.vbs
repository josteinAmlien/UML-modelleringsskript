...
Sub ListAsciiDoc(innrykk,thePackage)
	...
	Dim listTags, innrykkLokal, overskrift
	dim bilde, bildetekst, alternativbildetekst, diagramfil
...
'''	overskrift = appendArray( adocAvsnittSkille( ), adocDiskretOverskrift(innrykk, "Roller") )
